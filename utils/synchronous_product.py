...
def construct_prob_aware(pn1, im1, fm1, pn2, im2, fm2, skip, pn1_costs, pn2_costs, sync_costs):
    """
    Constructs the synchronous product with probability of transitions.
    ...
    :param fm2: Final marking of Petri net 2
    :param skip: Symbol to be used as skip
    :param pn1_costs: dictionary mapping transitions of pn1 to corresponding probability
    :param pn2_costs: dictionary mapping transitions of pn2 to corresponding probability
    :param sync_costs: probability of sync moves
